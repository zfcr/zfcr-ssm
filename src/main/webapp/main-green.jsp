...
<body class="body" style="background-color: #6E8B3D;">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form class="navbar-form navbar-right" role="search">
        ...
        <a class="button button-primary button-rounded button-small" href="#">搜索</a>
      </form>
...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-8 column"> <!-- border-right: 3px double red; -->
        	<div class="jumbotron" style="padding: 10px;background-color: rgba(168, 205, 37, 0.5);">
        	<div class="row">
        		<div class="col-md-6">
        	...
        	<div class="row">
			  ...
			  <li class="list-group-item" style="background-color: rgba(168, 205, 37, 0.5);border-color: rgba(168, 205, 37, 1);">
        ...
        <div class="col-md-4 column hidden-xs hidden-sm">
            <div class="panel panel-default" style="background-color: #6E8B3D;">
               <div class="panel-heading" style="background-color: rgba(168, 205, 37, 1);">
                   	最新文章
               </div>
               <div class="panel-body titleGrid" style="padding-top: 0px;background-color: rgba(168, 205, 37, 0.5);">
