...
<link rel="stylesheet" href="${ctx}/common/css/title.css">
<title>主页</title>
<style type="text/css">
	.caption {
...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-8 column">
        	<div class="jumbotron rec hidden-xs hidden-sm" style="padding: 10px;background-color: #C8D190;margin-bottom: 20px;">
	        	<div class="row">
	        		<s:iterator value="#request.recBlogInfos" var="recBlogInfo">
					  <div class="col-sm-6 col-md-4">
					    <div class="thumbnail">
					      <img src="${recBlogInfo.imagePath }" alt="${recBlogInfo.title }">
					      <div class="caption" style="padding: 0px;overflow: hidden;white-space: nowrap;">
					        <a href="${ctx }/blog/show/${recBlogInfo.id}" target="_blank" title="${recBlogInfo.title }">${recBlogInfo.title }</a>
					      </div>
					    </div>
					  </div>
	        		</s:iterator>
			  ...
			  <li class="list-group-item" style="background-color: #C8D190;border-color: rgba(168, 205, 37, 1);">
			  	<table style="overflow: hidden;">
						<tr>
							<td valign="middle"><img class="blog-main-img" src="${blogInfo.imagePath }"></td>
							<td style="padding-left: 15px; vertical-align: top;" valign="top">
								<div class="blog-title"><a href="${ctx }/blog/show/${blogInfo.id}" target="_blank">${blogInfo.title }</a></div>
								<div class="font-summary">
									<span class="glyphicon glyphicon-time"></span>
									<span><s:date name="#blogInfo.createTime" format="yyyy-MM-dd"/></span>

									<span class="space10 hidden-xs"></span>
									
									<span class="glyphicon glyphicon-user hidden-xs"></span>
									<span class="hidden-xs">${blogInfo.createUser }</span>
								...
								<div class="font-summary hidden-xs hidden-sm" style="height: 70px; overflow: hidden;word-wrap: break-word;white-space:normal;word-break:break-all;">
									${blogInfo.summary }
								</div>
							</td>
						</tr>
